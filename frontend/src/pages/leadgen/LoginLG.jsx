    ...
    <section className="bg-[#0c101b] min-h-screen flex items-center justify-center">
      ...
      p-5 items-center">
        ...
        <img
          ...
          <div className="mt-3 text-xs flex justify-between items-center text-[#f4f5fd]">
            <p>Don't have an account?</p>
            <button className="py-2 px-5 bg-[#002D74] rounded-xl hover:scale-110 duration-300">Register</button>
          </div>
        </div>
